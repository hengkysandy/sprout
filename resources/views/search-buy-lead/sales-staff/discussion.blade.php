    ...
    <div id="main" class="container-fluid">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <h1 class="main-title no-margin-top"><strong>PT Agung Jaya - Plate Material <span class="pull-right">Quotation : Rp59.000.000</span></strong></h1>
          <h4></h4>
        </div>
        ...
        <div class="col-md-6 col-sm-12 col-xs-12 hide-on-med-and-down">
