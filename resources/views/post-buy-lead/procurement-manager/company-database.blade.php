            ...
            <table id="cmpDb" class="table table-bordered table-hover table-middle">
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="#cancelApproval" data-toggle="modal" class="btn btn-sm btn-default">Cancel Approval</a></td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    <a href="#approveVendor" data-toggle="modal" class="btn btn-sm btn-success"><strong>Approve</strong></a>
                    <a href="#blacklistVendor" data-toggle="modal" class="btn btn-sm btn-danger"><strong>Blacklist</strong></a>
                  </td>
                  <td>
                    <a href="../../storage/sample.pdf" class="btn btn-sm btn-primary">Open Document</a>
                  </td>
                ...
                <tr>
                  ...
                  <td><a href="#cancelBlacklist" data-toggle="modal" class="btn btn-sm btn-default">Cancel Blacklist</a></td>
                  <td>
                    <a href="../../storage/sample.pdf" class="btn btn-sm btn-primary">Open Document</a>
                  </td>
                </tr>
