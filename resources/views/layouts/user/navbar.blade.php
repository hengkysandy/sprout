  ...
  <div class="container-fluid">
    <div class="logo">
      ...
      <div class="client-logo">
        ...
        <img style="font-size: 26px; line-height: 100px; margin:10px" src="" alt="Company Logo">
        <div class="client-identity">
          <span class="client-company">Company Name</span> <br>
          ...
          <span class="client-person">Full Name - Position</span>
        </div>
        <p class="client-tagline" style="margin-top: 15px">Place Your Company tagline Here</p>
      </div>
    </div>
  </div>
</nav>
