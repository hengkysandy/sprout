...
@section('content')
  @include('layouts.dashboard.navbar')
    ...
    -->
    <div class="modal fade" id="addSect" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
    ...
    <div class="modal fade" id="editSect" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-primary edit-sect">Save</button>
          </div>
          </form>
        </div>
      </div>
    ...
    <div class="modal fade" id="editDiv" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <div class="row">
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="form-group">
                    <label>Division</label>
                    <input type="text" id="name" name="name" class="form-control" value="Division 1">
                  </div>
                </div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <div class="form-group">
                    <label>Description</label>
                    <input type="text" name="description" id="description" class="form-control" value="Crop and animal production, hunting and related service activities">
                  </div>
                </div>
                <div class="col-md-12 col-sm-12 col-xs-12">
                  <div class="form-group">
                    <a href="#chooseGroup" data-toggle="modal" class="btn btn-default">Choose Group</a>
                  </div>
                </div>
              </div>
            
            <!-- Bila belum memilih group maka tidak dapat menambahkan division. Bila group telah di pilih maka akan muncul tabel yang menampilkan group group yang telah di pilih -->
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-primary edit-div">Save</button>
          </div>
          </form>
        </div>
      </div>
    ...
    <div class="modal fade" id="editGroup" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
            <button type="submit" class="btn btn-primary edit-group">Save</button>
          </div>
          </form>
        </div>
      </div>
