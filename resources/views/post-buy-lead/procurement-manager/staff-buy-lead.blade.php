        ...
        <div class="col-md-8 col-sm-12 col-xs-12">
          ...
          <div class="box box-primary margin-top">
            <div class="box-header with-border">
              <h3 class="box-title">Recently Added Buy Lead by Arifan</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <ul class="products-list product-list-in-box">
                <li class="item">
                  <div class="col-md-6 col-sm-6 col-xs-12 no-padding">
                    ...
                    <div class="product-info">
                      <div class="col-md-6 col-xs-12 no-padding">
                        <a href="post-buy-lead.html" class="product-title">Samsung TV</a>
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12 no-padding margin-top-med-and-down">
                    <a href="discussion.html" class="product-title">
                    ...
                    <a href="quotation-pm.html" class="product-title">
                      <div class="col-md-4 col-sm-4 col-xs-4 padding-btn-rl">
