    ...
    <div id="main" class="container-fluid">
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <h1 class="main-title no-margin-top">Buy Lead History</h1>
        </div>
              ...
              <div class="table-responsive">
                <table class="table no-border-table">
                  ...
                  <tr>
                    <th>Document</th>
                    <td>:</td>
                    <td><a href="../../storage/sample.pdf" class="btn btn-primary btn-xs">Open Document</a></td>
                  </tr>
                </table>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12 margin-top">
          <a class="btn btn-warning btn-sm" href="history-rfq.html"><i class="fa fa-arrow-left"></i> Back</a>
        </div>
      </div>
    </div>
